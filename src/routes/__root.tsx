  ...
  head: () => ({
    meta: [
      ...
      { title: "Atlas Sanctum — Civilization Operating System" },
      {
        name: "description",
        content:
          "See clearly. Act wisely. Flourish together. A systems-level platform for community reality, capital, missions and moral intelligence.",
      },
      { name: "author", content: "Atlas Sanctum" },
      { property: "og:title", content: "Atlas Sanctum — Civilization Operating System" },
      {
        property: "og:description",
        content: "A systems-level architecture experience for regenerative civilization.",
      },
